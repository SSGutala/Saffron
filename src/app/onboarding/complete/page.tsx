...
const TOOLS_META: Record<string, { name: string, icon: React.ReactNode }> = {
  google: {
  ...
  microsoft: {
    name: "Microsoft 365",
    icon: <svg className="w-5 h-5" viewBox="0 0 21 21"><path fill="#f25022" d="M1 1h9v9H1z"/><path fill="#00a4ef" d="M1 11h9v9H1z"/><path fill="#7fba00" d="M11 1h9v9h-9z"/><path fill="#ffb900" d="M11 11h9v9h-9z"/></svg>
  }
};
            ...
            <div className="mb-10">
              ...
              <div className="space-y-2">
                {connections.map((conn) => {
                  const meta = TOOLS_META[conn.providerId];
                  if (!meta) return null;
                  return (
                    <div key={conn.id} className="flex items-center justify-between p-3 rounded-lg bg-[#1a1a24] border border-white/5">
